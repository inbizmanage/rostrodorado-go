...
import { m as motion, useScroll, useTransform, useMotionValue, useSpring } from 'framer-motion';
    ...
    >
      ...
      <div className="relative z-20 text-center px-6 max-w-5xl mx-auto mt-20">
        ...
        >
          ...
          <span className="font-sans text-[10px] md:text-xs font-medium tracking-[0.3em] uppercase text-white/70 mb-8 drop-shadow-md">
            Medicina Estética & Anti-aging
          </span>
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            {/* Elegant Ring Pulse (Very subtle) */}
            <motion.div 
            ...
            <button
              ...
              className="group relative inline-flex items-center justify-center px-10 py-4 overflow-hidden border border-white/40 rounded-full text-white transition-all duration-300 hover:bg-white hover:text-charcoal hover:border-white cursor-hover backdrop-blur-sm"
